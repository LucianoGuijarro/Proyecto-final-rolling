...
import styles from './GridJuegosCarreras.module.css';

const GridJuegosCarreras = () => {
    const [juego, setJuego] = useState([]);
    useEffect(() => {
        clientAxios.get('/verJuegos/carreas')
        ...
        <>
            <div className="container">
                <div className={`row justify-content-around shadow rounded my-3 pb-3`}>
                    <p className='fs-1 text-center text-light'>Carreras</p>
                    {
                        juego.map((juego) => {
...
export default GridJuegosCarreras